          ...
          <div className="space-y-8">
            ...
            <div className="backdrop-blur-lg bg-white/10 rounded-2xl border border-white/20 shadow-[0_0_40px_rgba(192,132,252,0.15)] p-8">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold text-white">Admin-Bereich</h2>
              ...
              {error && (
                <div className="backdrop-blur-lg bg-red-500/30 rounded-2xl border border-red-500/20 p-4 mb-6">
            ...
            {/* Aktuelle Antworten */}
            <div className="backdrop-blur-lg bg-white/10 rounded-2xl border border-white/20 shadow-[0_0_40px_rgba(192,132,252,0.15)] p-8">
              <h2 className="text-2xl font-bold text-white mb-6">Aktuelle Antworten</h2>
              ...
              {isLoading ? (
                ...
                <div className="text-center py-12 text-gray-400">
                  <p className="text-xl">Keine Antworten vorhanden</p>
                  <p className="mt-2">Warten auf Antworten der Benutzer</p>
                </div>
              ) : (
                    ...
                    <Card key={answer.id} className="bg-black/40 border-white/10">
                      <CardHeader className="pb-2 flex justify-between items-start">
                        ...
                        <Button
                          ...
                          variant="outline"
                          size="sm"
                          className="bg-black/20 border-white/10 hover:bg-white/10 text-white"
                        >
                          Zurücksetzen
                        </Button>
                      </CardHeader>
